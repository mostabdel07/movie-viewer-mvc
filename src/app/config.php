...
{
    return get_project_dir() . '/public';
}
function get_source_dir(): string
{
    return get_project_dir() . '/src';
}

function get_app_dir(): string
{
    return get_project_dir() . '/src/app';
}
function get_lib_dir(): string
{
    return get_project_dir() . '/src/lib';
}

function get_controller_dir(): string
{
    return get_project_dir() . '/src/app/controller';
}
function get_model_dir(): string
{
    return get_project_dir() . '/src/app/model';
}
function get_view_dir(): string
{
    return get_project_dir() . '/src/app/view';
}
function get_utils_dir(): string
{
